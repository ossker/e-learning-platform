    ...
    <SingleCourseWrapper>
      <div className='course-intro mx-auto grid'>
        <div className='course-img'>
          <img src = {course_images.image}/>
        </div>
        <div className='course-details'>
          <div className='course-category bg-white text-dark text-capitalize fw-6 fs-12 d-inline-block'>KATEGORIA</div>
          ...
          <div className='course-body'>
            ...
            <ul className='course-info'>
              <li>
                <span className='fs-14'>Created by <span className='fw-6 opacity-08'>USERNAME</span></span>
              </li>
              <li className='flex'>
                <span><MdInfo /></span>
                <span className='fs-14 course-info-txt fw-5'>Last updated DATA</span>
              </li>
              <li className='flex'>
                <span><TbWorld /></span>
                <span className='fs-14 course-info-txt fw-5'>JĘZYK</span>
              </li>
              <li className='flex'>
          ...
          <div className='course-foot'>
            <div className='course-price'>
              <span className='new-price fs-26 fw-8'>NOWA CENA</span>
              <span className='old-price fs-26 fw-6'>STARA CENA</span>
              <span className='free-price fs-26 fw-8'>Free</span>
      ...
      <div className='course-full bg-white text-dark'>
        <div className='course-learn mx-auto'>
            ...
            <ul className='course-learn-list grid'>
                <li>
                    <span><BiCheck /></span>
                    <span className='fs-14 fw-5 opacity-09'>TOPIC</span>
                </li>
                <li>
                    <span><BiCheck /></span>
                    <span className='fs-14 fw-5 opacity-09'>TOPIC</span>
